<template>
  <div class="zmui-range-input-box" style="position:relative;margin-right:30px;margin-left:50px;">
    <input class="zmui-range-input" v-model.number="currentValue">
  </div>
</template>
  ...
  export default {
    ...
    mounted () {
      ...
      this.$nextTick(() => {
        ...
        this.range = new Powerange(this.$el.querySelector('.zmui-range-input'), options);
