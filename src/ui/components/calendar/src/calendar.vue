<template>
  <div class="zmui-calendar">
    <cell
      :title="title"
      primary="content"
      @click.native="onClick"
      :is-link="!readonly">
      <span class="zmui-cell-placeholder" v-if="shouldShowPlaceholder">{{ placeholder }}</span>
      <span class="zmui-cell-value" v-if="!shouldShowPlaceholder">{{ displayFormat(value, getType(value)) }}</span>
    </cell>
...
<style lang="less">
  ...
  .zmui-calendar {
    position: relative;
    &:before {
      .setTopLine(@zmuiCellBorderColor);
      left: @zmuiCellGapH;
    }
  }
</style>
