<template>
  <div class="zmui-swipeout-item"
       ...
       @mouseup="end"
       @touchcancel="end">
    <div class="zmui-swipeout-button-box zmui-swipeout-button-box-left" :style="leftButtonBoxStyle" v-show="distX >= 0">
      <slot name="left-menu"></slot>
    </div>
    <div class="zmui-swipeout-button-box" :style="rightButtonBoxStyle" v-show="distX <= 0">
      <slot name="right-menu"></slot>
    </div>
    <div class="zmui-swipeout-content" :style="styles" @mousedown="onContentClick" @touchstart="onContentClick" ref="content">
    ...
    methods: {
      ...
      setOffset (x, animated = false, force) {
        ...
        if (animated && this.target) {
          this.target && this.target.classList.add('zmui-swipeout-content-animated');
          const cb = (function (self, target) {
            return function () {
              target.classList.remove('zmui-swipeout-content-animated');
