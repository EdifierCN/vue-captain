import Scroller from '../../picker/src/scroller'
...
const TEMPLATE = `<div class="dp-container">
  <div class="dp-header">
    <div class="dp-item dp-left zmui-datetime-cancel" data-role="cancel">cancel</div>
    <div class="dp-item zmui-datetime-clear" data-role="clear"></div>
    <div class="dp-item dp-right zmui-datetime-confirm" data-role="confirm">done</div>
  </div>
...
DatetimePicker.prototype = {
  ...
  _show (newValueMap) {
    ...
    if (this.renderInline) {
      self.container.classList.add('zmui-datetime-view')
    }
  ...
  show (value) {
    ...
    if (config.isOneInstance) {
      if (document.querySelector('#zmui-datetime-instance')) {
        return
      }
      self.willShow = true
    }
    ...
    if (self.container) {
      ...
      if (config.isOneInstance) {
        container.id = 'zmui-datetime-instance'
      }
