<template>
  <img :src="defaultSrc" :data-src="currentSrc" class="zmui-lazy-img"/>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      init () {
        ...
        this.blazy = new Blazy({
          ...
          selector: `#zmui-lazy-img-${this.uuid}`,
          offset: _this.offset,
    ...
    mounted () {
      this.$el.setAttribute('id', `zmui-lazy-img-${this.uuid}`);
      this.$nextTick(() => {
        setTimeout(() => {
          this.init()
        }, this.delay)
