...
const getScrollview = function (el) {
    ...
    while (currentNode && currentNode.tagName !== 'HTML' && currentNode.tagName !== 'BODY' && currentNode.nodeType === 1) {
        ...
        let overflowX = document.defaultView.getComputedStyle(currentNode).overflowX;

        if (overflowY === 'scroll' || (overflowY === 'auto' && overflowX !== 'hidden')) {
...
const isParent = function (children, parent) {
...
export {pageScroll, preventScroll, isIOS, isColor, getScrollview, checkInview, addClass, removeClass, scrollTop, extendProp, isParent};
