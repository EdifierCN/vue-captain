<template>
  <div>
    <cell-group title="default range">
    ...
    <div style="margin:0 10px;">
      <button-cell type="primary" @click.native="update">update min = {{min}}, max = {{max}} and step = {{step}}</button-cell>
    </div>

    <cell-group title="Step">
    ...
    <cell-group title="two way binding">
    ...
    <cell-group :title="'use v-show ' + 'data: ' + data13">
      <cell title="Default" primary="content">
