<template>
  <div>
    ...
    <cell-group title="disabled = true">
    ...
    <cell-group title="custom star, some symbols like ♥ ❤ are not proper.">
      <cell title="loving">
...
<script>
  ...
  import { Rater } from '../../ui/components/rater'
