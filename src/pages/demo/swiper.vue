<template>
  <div>
    ...
    <button-cell @click.native="demo01_index = 0">go to 0</button-cell>
    <button-cell @click.native="demo01_index = 1">go to 1</button-cell>
    <button-cell @click.native="demo01_index = 2">go to 2</button-cell>
    ...
    <divider>设置aspect-ratio, 将自动根据宽度计算高度</divider>
    ...
    <divider>set index = 1 with swiper-item</divider>
    ...
    {{ swiperItemIndex }}
    <br>
    <button-cell @click.native="swiperItemIndex = 0">go to 0</button-cell>
    <button-cell @click.native="swiperItemIndex = 1">go to 1</button-cell>
    <button-cell @click.native="swiperItemIndex = 2">go to 2</button-cell>
    ...
    <divider>Async setting list data</divider>
    <swiper :list="demo05_list" auto height="180px" @on-index-change="demo05_onIndexChange"></swiper>
    <p> current index: {{demo05_index}}</p>
    <button-cell @click.native="demo05_onLoad(1)" type="primary" style="margin: 10px 0;">Load list1</button-cell>
    <button-cell @click.native="demo05_onLoad(2)" type="primary" style="margin: 10px 0;">Load list2</button-cell>

    <br/>
    <br/>
    <divider>华丽的分割线</divider>

    <divider>引入swiper-item自定义item内容，用height定义高度</divider>
...
<script>
  import { Swiper, SwiperItem } from '../../ui/components/swiper'
